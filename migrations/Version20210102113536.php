 ...
 */
final class Version20210102113536 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, commander_id INT NOT NULL, livraision_date DATETIME NOT NULL, created_at DATETIME NOT NULL, amount DOUBLE PRECISION NOT NULL, INDEX IDX_6EEAA67D3349A583 (commander_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT FK_6EEAA67D3349A583 FOREIGN KEY (commander_id) REFERENCES user (id)');
