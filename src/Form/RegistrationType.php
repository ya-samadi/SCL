...
class RegistrationType extends ApplicationType
{
    ...
    {
        $builder
            ->add('firstName', TextType::class, $this->getConfiguration('Prènom', 'Votre prènom ...'))
            ...
            ->add('passwordConfirm', PasswordType::class, $this->getConfiguration('Confiramtion de mot de passe', 'Resaisissez votre mot de passe !'))
